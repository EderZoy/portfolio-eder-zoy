              ...
              <div className="flex flex-wrap gap-4">
                {items.map((item, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className="flex items-center gap-2 bg-white dark:bg-gray-800 px-3 py-2 rounded shadow text-sm"
                    >
      ...
      <div className="ml-40 mt-16 w-full max-w-6xl">
        ...
        <div className="flex flex-wrap gap-4">
          {skills['Soft Skills'].map((skill, i) => (
            <span
              key={i}
              className="bg-white dark:bg-gray-800 px-4 py-2 rounded shadow text-sm"
            >
              {skill}
            </span>
          ))}
